...
var FrontPageComponent = (function () {
    function FrontPageComponent(router, recipeservice, likes) {
        ...
        this.ownTitle = "Your saved recipes";
...
var RecipeCardDetailedComponent = (function () {
    ...
    RecipeCardDetailedComponent.prototype.ngOnInit = function () {
        ...
        if (this.activeId) {
            ...
            this.recipequery.getRecipeById(this.activeId)
                ...
                _this.isLiked = _this.likes.isRecipeFavourite(_this.activeId);
    ...
    RecipeCardDetailedComponent.prototype.removeFromFavourites = function () {
        var recipe = {};
        recipe['id'] = parseInt(this.activeId);
...
module.exports = "<div class=\"container\" *ngIf=\"recipesFound\">\n\n    <h4>{{title}}</h4>\n\n    <app-cards-container (update)=\"saveUpdate($event)\" [recipes]=\"ownRecipes\" [imageurl]=\"imageurl\" *ngIf=\"ownRecipes\"></app-cards-container>\n\n    <button class=\"btn btn-warning\" (click)=\"emptyFavourites()\" *ngIf=\"showButton\">Clear favourites</button>\n\n</div>\n\n<div *ngIf=\"!recipesFound\">\n    <div class=\"container norecipes\">\n        <h3>Nothing found.</h3><br>\n        <h4>Favourite a recipe by clicking the heart icon, or the link \"add to favourites\" next to a recipe.</h4><br>\n        <p><img src=\"http://25.media.tumblr.com/9ea0453dbbb399af2ef67fd2ea6a8c6e/tumblr_mubwjr6kWh1rd0rbzo1_500.gif\"></p>\n    </div>\n</div>\n<br>"
...
module.exports = "<div class=\"container\">\r\n\r\n    <nav class=\"navbar navbar-toggleable-sm navbar-light\">\r\n        <div class=\"collapse navbar-collapse\" id=\"navbarNav\">\r\n\r\n            <ul class=\"navbar-nav mr-auto nav\">\r\n                <li class=\"nav-item\">\r\n                    <a class=\"navbar-brand\">\r\n                        <img src=\"https://trello-attachments.s3.amazonaws.com/588727fd73d9c03b796b7e16/306x282/1c03784ed78a3c26c554d8d85430b643/logo.png\" class=\"d-inline-block align-top\" alt=\"\">\r\n                    </a>      \r\n                </li>\r\n                <li class=\"nav-item verticalLine hidden-sm-down\">\r\n                </li>\r\n                <li class=\"nav-item navitem myhome\">\r\n                    <a [routerLink]=\"['/']\" class=\"nav-link\"><i class=\"fa fa-home nav-icon\" aria-hidden=\"true\"></i><span class=\"nav-hide\"><b>Home</b></span></a>\r\n                </li>\r\n                <li class=\"nav-item verticalLine hidden-sm-down\">\r\n                </li>\r\n                <li class=\"nav-item navitem mysearch\">\r\n                    <a [routerLink]=\"['/search']\" class=\"nav-link\"><i class=\"fa fa-search hidden-md-up nav-icon\" aria-hidden=\"true\"></i><span class=\"nav-hide\">Recipe search</span></a>\r\n                </li>\r\n                <li class=\"nav-item verticalLine hidden-sm-down\">\r\n                </li>\r\n                <li class=\"nav-item navitem myrecipes\">\r\n                    <a [routerLink]=\"['/favourites']\" class=\"nav-link\"><span class=\"nav-hide\">My recipes</span><i class=\"fa fa-heart nav-icon hidden-md-up showheart\" aria-hidden=\"true\"></i></a>\r\n                </li>\r\n            </ul>\r\n        </div>\r\n    </nav>\r\n</div>"
...
var LikesService = (function () {
    ...
    LikesService.prototype.isRecipeFavourite = function (recipeId) {
